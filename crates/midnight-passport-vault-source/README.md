...
plus a machine-readable compatibility manifest and reviewed circuit baselines.
...
`CONTRACT_SHA256`; build systems can read `manifest.json` directly from the
published crate or an immutable Git checkout.
