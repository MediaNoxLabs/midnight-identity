...
`contract/account.compact` applies one auditable downstream hardening patch on
that snapshot: k256 initial activation rejects unsupported boot envelope ids
before registering the first device.
